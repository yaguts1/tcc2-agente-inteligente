...
import { Settings, RefreshCw, CheckCircle, AlertCircle, Bed, User, Calendar } from 'lucide-react';
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-foreground">Admin - Eventos Órfãos</h1>
